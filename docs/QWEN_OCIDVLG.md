...
GroundingDINO detects the blue ball cleanly; GraspNet returns a horizontal grasp centred on it. Round objects have rotationally symmetric GT grasps, making the angle constraint easier to satisfy.
...
The model localises the pasta bag among multiple similar flat objects and produces a grasp aligned with the bag's long axis.
